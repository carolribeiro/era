...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { autor: @noticium.autor, data: @noticium.data, img: @noticium.img, texto: @noticium.texto, titulo: @noticium.titulo } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { autor: @noticium.autor, data: @noticium.data, img: @noticium.img, texto: @noticium.texto, titulo: @noticium.titulo } }
